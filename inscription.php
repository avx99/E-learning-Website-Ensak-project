...
<body>
  <div class="container">
    <div>
      ...
      <form id="form" class="form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>">
        ...
        <div class="form-control">
          ...
          <small>Error message</small>
          <span><?= "<div style='color:red'; 'margin-top:10px';> $error_email </div>" ?></span>
        </div>
        <div class="form-control">
    ...
    <div>
      <img src="images/undraw_sign_in_e6hj.png" alt="sing in" width="590" height="550">
    </div>
  </div>
</body>
